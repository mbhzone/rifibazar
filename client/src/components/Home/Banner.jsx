...
const Banner = () => {
  ...
  return (
    <div className="px-4 relative overflow-hidden  md:pt-25">
      ...
      {/* Left Image */}
      <div className="absolute top-16 left-0 w-30 md:w-1/3 -mt-22 lg:-mt-40 -ml-2 md:-ml-10">
        <img
          src={Image1}
          alt="Amloki"
      ...
      {/* Right Image */}
      <div
        className="absolute top-16 right-0 w-30  md:w-1/3 -mt-22 lg:-mt-40 
  -mr-2  lg:-mr-10 "
      >
        <img
          src={Image2}
      ...
      {/* Center Content */}
      <div className="text-center px-4 sm:px-6 relative z-10 max-w-2xl mx-auto ">
        <div className="inline-block">
          <div className="relative">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent pt-2">
              স্বাদ ও রুচি
            </h2>
        ...
        <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-700 mt-6 mb-4">
